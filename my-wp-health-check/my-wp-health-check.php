					...
					<td colspan="<?php echo esc_attr( $wp_list_table->get_column_count() ); ?>">
						<div>
							...
							printf(
								...
								esc_html__(
									'%s has not been updated in over two years which indicates that it is no longer supported by the developer.
							There could be security issues that will not be fixed! Please reach out to the developers to ensure this is still supported or look for alternatives and uninstall this plugin.',
									'my-wp-health-check'
								),
								esc_html( $name )
							);
